...
def arg_parse():
    ...
    parser.add_argument("--dataset_type", type = str, default = "7_desire_seeker_com.json")
    parser.add_argument("--model", type = str, choices = ['meta-llama/llama-3.1-8b-instruct','deepseek-r1-0528','deepseek-v3','deepseek-v3-0324','gpt-4o-mini','gpt-4o','gemini-2.5-flash-lite-preview-06-17','claude-3-5-haiku-20241022'])
    parser.add_argument("--cot", type=lambda x: (str(x).lower() == 'true'), default=False)
    args = parser.parse_args()
    return args


letters = ["A", "B", "C", "D", "E","F","G"]  # rec belief 
