...
def arg_parse():
    ...
    parser.add_argument("--dataset_type", type = str, default = "4_pred_seeker.json")
...
def evaluate(args, client, problem, idx):
    ...
    if args.cot == True:
        ...
        system_prompt = """You are an expert in dialogue analysis. Given a dialogue and a multiple-choice question, respond ONLY with the letter(s) of the correct choice(s) from A-D. Do not include any other text, punctuation, explanation, or whitespace. Example valid outputs: 'A', 'BC', 'ACD'."""
...
"""
    ...
    while True:
        ...
        if args.cot != True:
            ...
            try:
                candidates = extract_answers(result, 'A-D')
...
if __name__ == '__main__':
    ...
    with ThreadPoolExecutor(max_workers = 30) as executor:
        futures = {executor.submit(evaluate, args, client, problem , idx): idx  
